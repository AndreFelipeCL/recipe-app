package br.com.afcl.recipeapp.bootstrap;

import br.com.afcl.recipeapp.domain.ingredient.Ingredient;
import br.com.afcl.recipeapp.domain.ingredient.UnitOfMeasure;
import br.com.afcl.recipeapp.domain.ingredient.UnitOfMeasureRepository;
import br.com.afcl.recipeapp.domain.note.Note;
import br.com.afcl.recipeapp.domain.recipe.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private List<Recipe> getRecipes() {
		...
		//get Categories
		Optional<Category> americanCategoryOptional = categoryRepository.findOneByCategoryName("American");

		if (!americanCategoryOptional.isPresent()) {
			throw new RuntimeException("Expected Category Not Found");
		}

		Optional<Category> mexicanCategoryOptional = categoryRepository.findOneByCategoryName("Mexican");
		...
		guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(0.5), teapoonUom, guacRecipe));
