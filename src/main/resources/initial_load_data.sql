...
values (NEXTVAL('INGREDIENT_ID_SEQ'), 2.00, 'freshly grated black pepper', 1, 11),
       ...
       (NEXTVAL('INGREDIENT_ID_SEQ'), 0.50, 'cherry tomatoes, halved', 2, 12),
...
-- INSERT RECIPE
insert into RECIPE (ID, COOK_TIME, DESCRIPTION, DIFFICULTY, DIRECTIONS, IMAGE, PREPARATION_TIME, SERVING, SOURCE, URL, NOTE_ID)
values (NEXTVAL('RECIPE_ID_SEQ'), 0, 'Perfect Guacamole', 'EASY', '16473', null, 10, null, null, null, 1),
       (NEXTVAL('RECIPE_ID_SEQ'), 9, 'Spicy Grilled Chicken Taco', 'MEDIUM', '16475', null, 20, null, null, null, 2)
;
