...
CREATE SEQUENCE NOTE_ID_SEQ MINVALUE 1 START WITH 1 INCREMENT BY 1 CACHE 5;
CREATE TABLE NOTE
(
    ID          NUMERIC(19, 0) NOT NULL,
    RECIPE_NOTE TEXT,
...
--rollback DROP SEQUENCE NOTE_ID_SEQ;
...
ALTER TABLE NOTE
    ADD CONSTRAINT FK_RECIPE_ID FOREIGN KEY (RECIPE_ID) REFERENCES RECIPE;
ALTER TABLE RECIPE
    ADD CONSTRAINT FK_NOTE_ID FOREIGN KEY (NOTE_ID) REFERENCES NOTE;
ALTER TABLE INGREDIENT
    ADD CONSTRAINT FK_RECIPE_ID FOREIGN KEY (RECIPE_ID) REFERENCES RECIPE;
ALTER TABLE INGREDIENT
    ADD CONSTRAINT FK_UNIT_OF_MEASURE_ID FOREIGN KEY (UNIT_OF_MEASURE_ID) REFERENCES UNIT_OF_MEASURE;
ALTER TABLE RECIPE_CATEGORY
    ADD CONSTRAINT FK_RECIPE_ID FOREIGN KEY (RECIPE_ID) REFERENCES RECIPE;
ALTER TABLE RECIPE_CATEGORY
    ADD CONSTRAINT FK_CATEGORY_ID FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORY;
--rollback ALTER TABLE NOTE DROP CONSTRAINT FK_RECIPE_ID;
--rollback ALTER TABLE RECIPE DROP CONSTRAINT FK_NOTE_ID;
