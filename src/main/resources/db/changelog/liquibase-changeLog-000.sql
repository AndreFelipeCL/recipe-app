...
ALTER TABLE NOTE ADD CONSTRAINT FK_RECIPE_ID FOREIGN KEY (RECIPE_ID) REFERENCES RECIPE;
ALTER TABLE RECIPE ADD CONSTRAINT FK_NOTE_ID FOREIGN KEY (NOTE_ID) REFERENCES NOTE;
